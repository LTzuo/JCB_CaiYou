 ...
 */
public class MoreLotteryAdapter extends AbsRecyclerViewAdapter {
    ...
    public MoreLotteryAdapter(RecyclerView recyclerView) {
        super(recyclerView);
    }
    ...
    public ClickableViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ItemViewHolder(
                LayoutInflater.from(getContext()).inflate(R.layout.item_more_lottery, parent, false));
    }
