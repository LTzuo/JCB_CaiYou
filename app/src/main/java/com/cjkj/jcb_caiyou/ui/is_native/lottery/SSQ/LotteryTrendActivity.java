...
import com.cjkj.jcb_caiyou.widget.lottery_trend.data.TrendData;
import com.cjkj.jcb_caiyou.widget.lottery_trend.ui.LottoTrendView;
import com.cjkj.jcb_caiyou.widget.lottery_trend.ui.TrendChart;
...
public class LotteryTrendActivity extends RxBaseActivity implements TrendChart.ISelectedChangeListener {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message paramMessage) {
            ...
            LotteryTrendActivity.this.mTrendChart.updateData("01", (ArrayList) paramMessage.obj);
        }
    };
